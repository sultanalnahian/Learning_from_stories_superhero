...
pickle.dump(training_scores, open( "result/random/gg_mix-training_scores_random.p", "wb" ) )
pickle.dump(all_task_specific_command_list, open( "result/random/gg_mix_task_number_with_gg_random.p", "wb" ) )
pickle.dump(all_altruistic_command_list, open( "result/random/gg_mix_altruistic_number_with_gg_random.p", "wb" ) )


print("task: ", all_task_specific_command_list)
print("altruism: ", all_altruistic_command_list)
file1 = open('result/random/test_random_superhero_10_facts_4000_gg_mix.txt', 'w') 
